...
#define read_reg_multi(reg, pData, size)                                  \
        i2c_read_multi_dma(&hi2c2, ICM20948_ADDR << 1, reg, I2C_REG_8BIT, \
                           pData, size)
#define write_reg_multi(reg, pData, size)                                 \
        i2c_write_multi_dma(&hi2c2, ICM20948_ADDR << 1, reg, I2C_REG_8BIT,\
                            pData, size)
 ...
 * @param gyro_lp see enum gyro_low_pass
 * @param accel_lp see enum accel_low_pass
